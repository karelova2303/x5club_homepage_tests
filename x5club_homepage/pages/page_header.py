...
class PageHeader():
    ...
    def should_be_clickable_link_about(self):
        ...
        with allure.step('Отображается контент "О Х5 Клубе"'):
    ...
    def should_be_clickable_link_participant(self):
        ...
        with allure.step('Отображается контент "Как стать участником"'):
    ...
    def should_be_clickable_link_partners(self):
        ...
        with allure.step('Отображается контент "Партнеры"'):
    ...
    def should_be_clickable_link_mobile_app(self):
        ...
        with allure.step('Отображается контент "Мобильные приложения"'):
    ...
    def should_be_clickable_link_common_question(self):
        ...
        with allure.step('Отображается контент "Вопросы и ответы"'):
